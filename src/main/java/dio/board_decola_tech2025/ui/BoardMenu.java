...
import dio.board_decola_tech2025.service.BoardColumnQueryService;
import dio.board_decola_tech2025.service.BoardQueryService;
import dio.board_decola_tech2025.service.CardQueryService;
import dio.board_decola_tech2025.service.CardService;
        ...
        try {
            ...
            while (option != 9) {
                ...
                switch (option) {
                    ...
                    case 7 -> showColumn();
                    case 8 -> showCard();
                    case 9 -> System.out.printf("Voltando para o menu anterior.");
            ...
            new CardQueryService(connection).findById(selectedCardId)
                    .ifPresentOrElse(
                            c -> {
                                ...
                                System.out.println(c.blocked() ? "Está bloqueado. Motivo: " + c.blockReason() : "Nao está bloqueado.");
